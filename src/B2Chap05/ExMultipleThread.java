...
//Multiple Thread class by Extending Thread class
public class ExMultipleThread extends Thread{
	...
	public ExMultipleThread(){
		buildGUI();
	}
	public ExMultipleThread(String s){
		super(s);
	}
	public void run()
	{
	...
	public static void main(String[] args) {
		...
		ExMultipleThread obj=new ExMultipleThread();
