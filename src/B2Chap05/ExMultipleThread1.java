...
//Multiple Thread class by Runnable Interface
public class ExMultipleThread1 implements Runnable{
	String ThreadName;
	JLabel l;
	JPanel l1,l2,l3;
	JFrame fr;
	
	public ExMultipleThread1(){
		buildGUI();
	}
	public void run()
	{
	...
	public static void main(String[] args) {
		...
		ExMultipleThread1 obj=new ExMultipleThread1();
